...
const MainHeaderList: React.FC<{ children: React.ReactNode }> = ({
    ...
    return (
        <ul
            ...
            gap-5 shadow shadow-accent transition duration-300 border-primary/20 hover:-translate-y-px 
            hover:shadow-xl hover:shadow-accent hover:border-primary sm:px-10 sm:mt-0 sm:px-10 sm:gap-7 
