    ...
    return (
        <footer 
            ...
            <div 
                ...
                <div className="mt-14 tracking-tight flex flex-col gap-4">
                    ...
                    <div className="pl-6 flex flex-col gap-2">
                        ...
                        <div className="flex flex-row items-center gap-2 text-primary">
                            ...
                            <span className="underline">pcle.worx@gmail.com</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-14 max-w-xs tracking-tight">Fill in the form and we will reach out to you shortly.</div>
            </div>

            <form 
                onSubmit={(e) => handleSubmit(e)}
                className="w-1/2 flex-col gap-10 bg-primary/70 p-10 rounded-2xl text-black max-md:w-full">
                <label htmlFor="name" className="font-semibold tracking-tight text-xl">Name</label>
                <input 
                    required
                    ref={inputFields["name"]}
                    id="name" 
                    name="name" 
                    type="text"
                ...
                <label htmlFor="Email" className="font-semibold tracking-tight text-xl">Email</label>
                <input 
                    required
                ...
                <div className="flex flex-col relative mb-5">
                    <label htmlFor="dropdown" className="font-semibold tracking-tight text-xl">Reasons to Connect</label>
                    <button 
                    ...
                    >
                        <span>{dropdown.selected !== undefined ? dropdown.selected : "Select Reason"}</span>
                        <FaHeart />
                    </button>

                    <ul 
                        className={`${dropdown.toggled !== true && "hidden"} rounded-2xl top-5 absolute 
                        top-24 w-full z-10 flex flex-col transition duration-300`}>
                        {[
                            "Product Inquiries", 
                            "Technical Support", 
                            ...
                            <a 
                                ...
                                key={index} 
                                className={`px-5 py-4 hover:bg-zinc-100 transition duration-300 bg-white
                                cursor-pointer ${index === 0 && "rounded-t-xl"} ${index === 4 && "rounded-b-xl"}`}
                            >
                                {reason}
                            </a>
                        ))}
                ...
                <div className="flex flex-col">
                    <label htmlFor="message" className="font-semibold tracking-tight text-xl">Message</label>
                    <textarea 
                        required
